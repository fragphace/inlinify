var Inlinifier, async, fs, jsdom, path, url, _;
...
Inlinifier = (function() {
  ...
  Inlinifier.prototype.getRelativeResource = function(url, callback) {
    return callback();
  };
  ...
  Inlinifier.prototype.inlinifyScript = function(script, callback) {
    ...
    return this.getRelativeResource(script.src, function(err, res) {
  ...
  Inlinifier.prototype.inlinifyStyle = function(link, callback) {
    var _this = this;
    return this.getRelativeResource(link.href, function(err, res) {
      var style;
